...
const seedUsers = () => db.Promise.map([
  {name: 'Jane Smith', email: 'jane@example.gov', password: '1234', sleepDebt: 2.70, averageSleep: 8.5},
  {name: 'Aly Khaya', email: 'aly@example.gov', password: '1234', averageSleep: 8.3, sleepDebt: 4.30},
  {name: 'so many', email: 'god@example.com', password: '1234', averageSleep: 8, sleepDebt: 4.30},
  {name: 'Barack Obama', email: 'barack@example.gov', password: '1234', averageSleep: 6, sleepDebt: 5.30},
